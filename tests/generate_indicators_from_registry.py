...
path = "data/raw/4h/ETHUSDT_4h_01-01-2016_18-01-2026.csv"
...
# ---------------------------------------------------
target1 = NormalizedFutureReturn(df,horizon=7, window=14)
target2 = NormalizedFutureReturn(df,horizon=7, window=28)
target3 = NormalizedFutureReturn(df, window=14)
target4 = NormalizedFutureReturn(df, window=28)
...
# Exportación
# ---------------------------------------------------------------------------
df.to_csv("data/processed/ETHUSDT_4h_01-01-2016_18-01-2026.csv")
