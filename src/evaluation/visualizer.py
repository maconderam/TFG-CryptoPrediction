...
class VisualizerWalkForward:
    ...
    def plot(self, title: str = None) -> go.Figure:
        ...
        fig.add_hline(y=0, line=dict(color="#333333", width=0.5), row=3, col=1)
        ...
        fig.add_hline(y=0, line=dict(color="#333333", width=0.5), row=4, col=1)
    ...
    def plot_walkforward_metrics(self) -> go.Figure:
        ...
        fig.add_hline(y=1.0, line=dict(color="#333333", width=0.8, dash="dash"), row=2, col=1)
    ...
    def plot_pf_evolution(self) -> go.Figure:
        ...
        if has_mcpt:
            ...
            fig.add_hline(y=0.05, line=dict(color="#333333", width=1, dash="dash"), row=2, col=1)
